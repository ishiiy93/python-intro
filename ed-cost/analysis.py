...
ed_data = ed.data.rename(columns = {'2012-13 Tuition and fees':'tuition.2012', 
									'2014-15 Tuition and fees':'tuition.2014', 
									'Sectior name':'sector', 
									'Name of institution':'institution'}

ed_data = ed.data.rename(columns = {'2012-13 Tuition and fees':'tuition.2012', '2014-15 Tuition and fees':'tuition.2014', 'Sector name':'sector', 'Name of institution':'institution'}

# How many UNIQUE institutions are there? What data structure could you
# leverage?
inst = ed_data.get("institution") #or ed_data["institution"]
ninst = len(set(inst))
